  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((duration) {
      ...
      cosFi = double.tryParse(
          cubit.state.response.data?.lastedLogData.paramPf ?? "0") ?? 0;
    });
  }
                                      ...
                                      pointers: <GaugePointer>[
                                        NeedlePointer(
                                          value: double.tryParse(
                                              state.response.data?.lastedLogData
                                                  .paramUa ?? "0") ?? 0,
                                          needleEndWidth: 1,
                                      ...
                                      annotations: <GaugeAnnotation>[
                                        GaugeAnnotation(
                                            widget: Container(
                                              ...
                                              child: Text('${state.response.data
                                                  ?.lastedLogData.paramUa} V',
