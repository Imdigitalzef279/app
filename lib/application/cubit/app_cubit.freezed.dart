...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({this.isShowLoading = false});
  ...
  @override
  String toString() {
    return 'AppState(isShowLoading: $isShowLoading)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({final bool isShowLoading}) = _$AppStateImpl;
