...
abstract class $DeviceRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int powerStationId, String sorting, int skipCount, int maxResultCount});
}
...
class _$DeviceRequestImpl implements _DeviceRequest {
  ...
  @override
  String toString() {
    return 'DeviceRequest(powerStationId: $powerStationId, sorting: $sorting, skipCount: $skipCount, maxResultCount: $maxResultCount)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, powerStationId, sorting, skipCount, maxResultCount);
...
abstract class _DeviceRequest implements DeviceRequest {
  const factory _DeviceRequest(
      ...
      final String sorting,
      final int skipCount,
      final int maxResultCount}) = _$DeviceRequestImpl;
