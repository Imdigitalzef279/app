...
class SolarElectricRepositoryIml extends BaseRepository
  ...
  @override
  Future<Result<PaginationResponse<LastedLogDataResponse>>> getChartElectric(ChartElectricRequest request) {
    // TODO: implement getChartElectric
    return callApiPagination(() => api.getChartElectric(request));
  }
}
